...
class Product(object):
    def __repr__(self):
        return "{productId: %s, productName: %s, category: %s, unitPrice: %.2f, unitsInStock: %d}" % (
            self.ProductID, self.ProductName, self.Category, self.UnitPrice, self.UnitsInStock)
...
class Customer(object):
    def __init__(self, CustomerID=None, CompanyName=None, Address=None, City=None, Region=None, PostalCode=None,
                 Country=None, Phone=None, Fax=None):
...
def getProductList():
    result = [Product(1, "Chai", "Beverages", 18.0000, 39), Product(2, "Chang", "Beverages", 19.0000, 17),
              ...
              Product(9, "Mishi Kobe Niku", "Meat/Poultry", 97.0000, 29), Product(10, "Ikura", "Seafood", 31.0000, 31),
              Product(11, "Queso Cabrales", "Dairy Products", 21.0000, 22),
              Product(12, "Queso Manchego La Pastora", "Dairy Products", 38.0000, 86),
              Product(13, "Konbu", "Seafood", 6.0000, 24), Product(14, "Tofu", "Produce", 23.2500, 35),
              ...
              Product(36, "Inlagd Sill", "Seafood", 19.0000, 112), Product(37, "Gravad lax", "Seafood", 26.0000, 11),
              ...
              Product(44, "Gula Malacca", "Condiments", 19.4500, 27), Product(45, "Rogede sild", "Seafood", 9.5000, 5),
              Product(46, "Spegesild", "Seafood", 12.0000, 95), Product(47, "Zaanse koeken", "Confections", 9.5000, 36),
              Product(48, "Chocolade", "Confections", 12.7500, 15), Product(49, "Maxilaku", "Confections", 20.0000, 10),
              ...
              Product(73, "Röd Kaviar", "Seafood", 15.0000, 101), Product(74, "Longlife Tofu", "Produce", 10.0000, 4),
...
def getCustomerList():
    result = []
    file_name = ("%s/../../Customers.json" % os.getcwd())
